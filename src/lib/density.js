 ...
 */
export function relax(bubbles, passes = 2, padding = 0.5) {
...
export function radiusScale(maxValue, maxRadius) {
  const safeMax = maxValue > 0 ? maxValue : 1;
  return (value) => (value <= 0 ? 0 : Math.sqrt(value / safeMax) * maxRadius);
}
