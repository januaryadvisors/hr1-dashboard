...
export interface LineSeries {
  label: string;
  values: (number | null)[];
  /** CSS colour. Defaults to navy for the first series. */
  color?: string;
  /** Dashed, for a comparison series that is not the subject. */
  dashed?: boolean;
}
...
export interface LineChartProps {
  months: string[];
  series: LineSeries[];
  /** Inclusive month range to shade, usually the policy window. */
  shade?: [string, string];
  /** Formatter for the y axis. Defaults to millions. */
...
export function lastFinite(values: (number | null)[]): { i: number; v: number } | null {
