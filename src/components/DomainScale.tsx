...
export interface DomainScaleProps {
  layer: LayerKey;
  /** This county's value, on the layer's own scale. */
  value: number | null;
  /** The statewide median, on the same scale. */
  median: number;
  /** Scale bounds — 0–1 for domains, 0–4 for the composite. */
  domain: [number, number];
  /**
   * 'full'    every band coloured, plus a caret and the median tick.
