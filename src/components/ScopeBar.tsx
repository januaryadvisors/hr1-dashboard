...
import type { LossRank, Scope, WindowChange } from '../lib/insights';
...
export interface ScopeBarProps {
  counties: County[];
  scope: Scope;
  /** Enrollment change across the active window, for the scope. */
  change: WindowChange;
  /** Where the county ranks among all 254. null when scoped to the state. */
  rank: LossRank | null;
