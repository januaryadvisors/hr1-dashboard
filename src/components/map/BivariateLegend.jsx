...
/**
 * @typedef {import('../../config/layers').BivariateAxis} BivariateAxis
 */
import styles from './BivariateLegend.module.css';

/**
 * @typedef {Object} BivariateLegendProps
 * @property {[BivariateAxis, BivariateAxis]} axes - [red axis, blue axis], in the order LayerValues carries them.
...
export function BivariateLegend({ axes, steps = BIVARIATE_STEPS }) {
